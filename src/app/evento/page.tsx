      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="flex justify-center gap-4 mb-12">
          <button 
            ...
            className={`px-6 py-3 font-semibold uppercase tracking-widest text-sm transition-colors border ${eventType === "casamento" ? "border-accent bg-accent text-primary" : "border-white/20 text-secondary hover:border-accent"}`}
          >
            Casamento
          </button>
          <button 
            ...
            className={`px-6 py-3 font-semibold uppercase tracking-widest text-sm transition-colors border ${eventType === "outros" ? "border-accent bg-accent text-primary" : "border-white/20 text-secondary hover:border-accent"}`}
          >
            Outros Eventos
          </button>
        </div>
